...
import { Calendar, Clock, Phone, CheckCircle, CreditCard, ShieldCheck } from 'lucide-react';
      ...
      <div className="mt-20 bg-blue-600 rounded-[3rem] p-12 text-white relative overflow-hidden shadow-2xl shadow-blue-200">
         ...
         <div className="relative z-10 max-w-2xl mx-auto text-center">
            ...
            <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
               ...
               <button 
                 disabled={!selectedTier}
                 className="flex items-center justify-center px-8 py-4 bg-blue-700 border border-blue-400 text-white rounded-full font-bold hover:bg-blue-800 transition-all disabled:opacity-50"
               >
